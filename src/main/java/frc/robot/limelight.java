...
public class limelight {
    ...
    public static double limelightmountangledegrees = 30.0;// please update these values 
    //distance from the center of the Limelight to the floor
    public static double limelightheightinches = 41.75;// please update these values 
    //distance from target to floor
    public static double goalHeightInches = 104;// please update these values 
